    ...
    render() {
        ...
        return (
            ...
            <div className="text-center comicdiv">
                ...
                <img className="preloader" src={this.props.preload1} alt={'preload1'} onLoad={this.props.loaded}/>
                <img className="preloader" src={this.props.preload2} alt={'preload2'} onLoad={this.props.loaded}/>
            </div>
        );
    }
}
